                    ...
                    <div className="text-center py-12">
                        <div className="bg-white rounded-lg shadow-md p-8 max-w-2xl mx-auto">
                            <div className="mb-6">
                                ...
                                <h2 className="text-3xl font-bold text-gray-900 mb-4">Welcome to Career Compass AI! 🎯</h2>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6">
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                <span className="text-sm font-medium text-blue-700">{parsingStep}</span>
                                <span className="text-sm text-gray-500">{parsingProgress}%</span>
                            </div>
